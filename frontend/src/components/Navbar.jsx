...
export function Navbar({
  ...
  return (
    <header className="sticky top-0 z-20 bg-white border-b border-slate-200/90 shadow-2xs">
      <div className="px-4 sm:px-6 lg:px-8 min-h-16 py-2 lg:py-0 flex items-center justify-between gap-3 lg:gap-4">
        {/* Left Side: Hamburger & Branding */}
        <div className="flex items-center gap-2.5 sm:gap-3.5 min-w-0">
          <button
            type="button"
            onClick={onOpenMobileSidebar}
            className="lg:hidden p-2 rounded-md text-slate-600 hover:bg-slate-100 hover:text-slate-900 focus:outline-hidden shrink-0"
          ...
          <div className="flex items-center gap-2.5 min-w-0">
            ...
            <div className="flex flex-col min-w-0">
              ...
              <p className="text-[11px] text-slate-500 font-medium tracking-wide mt-0.5 leading-tight">
        ...
        {/* Right Side: Anniversary Badge & Profile */}
        <div className="flex items-center gap-2 sm:gap-3 shrink-0">
          ...
          <div className="flex items-center gap-2 pl-2 border-l border-slate-200">
            <div className="w-8 h-8 rounded-full bg-[#1a365d] text-white flex items-center justify-center text-xs font-bold shadow-2xs shrink-0">
